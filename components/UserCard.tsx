...
<div class={tw`items-center`}>
  <div class={tw`relative`}>
    <details>
      <summary class={tw`flex m-1 list-none items-center rounded-md text-center hover:bg-gray-200 p-1`} title="See user info">
      <img src={props.obj.icon[0]} class={tw`w-8 rounded-full shadow-md mr-2`} />
      {props.obj.name}
      </summary>
      <div class="absolute left-2 w-30 bg-white py-3 text-center shadow-lg">
        <a href={props.obj.id}><div class={tw`text flex items-center px-4 py-1 hover:bg-gray-200`}>Profile</div></a>
        <a href={props.obj.following}><div class="text flex items-center px-4 py-1 hover:bg-gray-200">Following</div></a>
        <a href={props.obj.liked}><div class="text flex items-center px-4 py-1 hover:bg-gray-200">Likes</div></a>
      </div>
    </details>
  </div>
</div>
